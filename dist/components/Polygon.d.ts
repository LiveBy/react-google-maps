 ...
 */
export class Polygon extends React.PureComponent<any, any, any> {
    static propTypes: {
        /**
         * @type boolean
         */
         ...
         */
        defaultPaths: MVCArray<MVCArray<LatLng>> | MVCArray<LatLng> | Array<Array<LatLng | LatLngLiteral>> | Array<LatLng | LatLngLiteral>;
        /**
         * @type boolean
         */
         ...
         * @type MVCArray<MVCArray<LatLng>>|MVCArray<LatLng>|Array<Array<LatLng|LatLngLiteral>>|Array<LatLng|LatLngLiteral>
         */
        paths: MVCArray<MVCArray<LatLng>> | MVCArray<LatLng> | Array<Array<LatLng | LatLngLiteral>> | Array<LatLng | LatLngLiteral>;
        /**
         * @type boolean
         */
        visible: boolean;
    ...
    state: {
        __SECRET_POLYGON_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: any;
    };
